...
class UpdatePatientPage extends StatefulWidget {
  ...
  const UpdatePatientPage({Key? key, required this.patientId})
      : super(key: key);
  @override
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  TextField(
                      controller: TextEditingController(text: "Rania Musk"),
                      onChanged: (value) {},
                  ...
                  const SizedBox(
                      height:
                          10), //Source: https://api.flutter.dev/flutter/material/DropdownButton-class.html
                  SizedBox(
                  ...
                  TextField(
                      ...
                      decoration: const InputDecoration(
                        floatingLabelBehavior: FloatingLabelBehavior.never,
                        labelText:
                            '56 Electric Avenue, Darby, Ontario', // Placeholder text
                        border: OutlineInputBorder(),
                      )),
